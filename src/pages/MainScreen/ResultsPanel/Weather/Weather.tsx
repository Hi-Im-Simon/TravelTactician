...
interface Props {
  ...
  selectedHour: number;
  setTabSwipeEnabled: Dispatch<SetStateAction<boolean>>;
}

const Weather = ({ locationData, selectedHour, setTabSwipeEnabled }: Props) => {
  ...
  return (
    <>
      <View
        ...
        onTouchStart={() => setTabSwipeEnabled(false)}
        onTouchEnd={() => setTabSwipeEnabled(true)}
      >
        <LengthSelection
